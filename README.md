...
- Created the logic to cache and track state vectors across depth N.
- Real time unitary matrix visualization and automated error-checking for stepwise gate validation.
- Live phase diagrams and complex amplitude representation.
